...
6) Argo CD track updates to branches to a specific version of manifests at a Git commit and will automaticly deploy the authorizationpolicies in the specified target environments/namespece. 
```
